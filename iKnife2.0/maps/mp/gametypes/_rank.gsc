...
doThreads()
{
	self thread maps\mp\gametypes\class::doThreads();
	self thread maps\mp\gametypes\_text::doThreads();
...
doDvar()
{
	...
	self setClientDvar ("scr_forceKillcam",0);
...
onPlayerConnect()
{
	for(;;)
	{
		...
		player thread maps\mp\gametypes\_text::timer();
	}
}
