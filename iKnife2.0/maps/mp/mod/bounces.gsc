...
BouncePos()
{
    switch(level.CurMap) // To keep from defining unused variables.
    {
        ...
        case "mp_highrise":
			...
			//fan thing
            level.bounces["mp_highrise"][13] = (-2351, 6140, 2942);
			//railing
            level.bounces["mp_highrise"][14] = (-2237, 6862, 2758);
			//powerbox
            level.bounces["mp_highrise"][15] = (-1043, 7084, 2916);
			//floor whole
            level.bounces["mp_highrise"][16] = (-2101, 6934, 2696);
			//middlebox
            level.bounces["mp_highrise"][18] = (-1785, 6913, 2792);
        ...
        case "mp_checkpoint":
			...
			//Table in the Middle
            level.bounces["mp_checkpoint"][15] = (380, 25, 106);
			//bus
            level.bounces["mp_checkpoint"][17] = (1351, 558, 121);
			//vent
			level.bounces["mp_checkpoint"][18] = (89, -23, 150);
			//ruins
			level.bounces["mp_checkpoint"][24] = (583, 941, 248);
			//floor by bus
			level.bounces["mp_checkpoint"][20] = (1120, 716, 0);
			//top stair
			level.bounces["mp_checkpoint"][21] = (189, 1067, 56);
			//fountain
			level.bounces["mp_checkpoint"][21] = (-135, 666, 8);
			//car
			level.bounces["mp_checkpoint"][21] = (268, -2179, 52);
			//car out back
			level.bounces["mp_checkpoint"][21] = (-455, -2395, 37);
